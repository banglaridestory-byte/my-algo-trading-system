...
def run_scanner_strategies(df, timeframe="5m"):
    """
    input: pandas DataFrame with ['open', 'high', 'low', 'close', 'volume'] and selected timeframe
    ...
    try:
        ...
        # ৩. EMA Crossover (9 EMA cutting above 21 EMA)
